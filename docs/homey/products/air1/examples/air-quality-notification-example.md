...
![](../../general/tutorials/assets/homey-flow-example-pic-5-1.png)

8\. Click "Add" and select "Then" and search for "set a color" and choose the AIR-1 device option.

![](../../general/tutorials/assets/homey-flow-example-pic-6.png)
...
![](../../general/tutorials/assets/homey-flow-example-pic-12.png)![](../../general/tutorials/assets/homey-flow-example-pic-13.png)

![](../../general/tutorials/assets/homey-flow-example-pic-11.png)

13\. Click "User" and choose "Everyone who's home" or your preferred option.

![](../../general/tutorials/assets/homey-flow-example-pic-18.png)
...
![](../../general/tutorials/assets/homey-flow-example-pic-15.png)

14\. Click "Add" and select "Then" and search for "turn off" and choose the AIR-1 device option.

![](../../general/tutorials/assets/homey-flow-example-pic-14.png)
...
![](../../general/tutorials/assets/homey-flow-example-pic-16-1.png)
...
![](../../general/tutorials/assets/homey-flow-example-pic-17-1.png)
