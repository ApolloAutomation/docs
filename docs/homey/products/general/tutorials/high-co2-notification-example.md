...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-1.png)

3\. Click "Add" and select "When".

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-2.png)
...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-3-1.png)

5\. Place your card on your flow area with a left click. You should have this node on your flow canvas.

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-4-1.png)

6\. Select "ppm" and type in your value, we will use 999.

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-7.png)
...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-5-1.png)

8\. Click "Add" and select "Then" and search for "set a color" and choose the AIR-1 device option.

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-6.png)
...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-8.png)

10\. Duplicate steps 7 and 8 but this time select green for the color when "CO2 becomes less than 1000 ppm".

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-10.png)

11\. Click "Add" and select "Then" and search "push" and choose "Send message to user".

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-9.png)
...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-12.png)![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-13.png)

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-11.png)

13\. Click "User" and choose "Everyone who's home" or your preferred option.

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-18.png)
...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-15.png)

14\. Click "Add" and select "Then" and search for "turn off" and choose the AIR-1 device option.

![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-14.png)
...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-16-1.png)
...
![](../../../../assets/homey-products-general-tutorials-homey-flow-example-pic-17-1.png)
