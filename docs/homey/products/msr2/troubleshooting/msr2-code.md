...
![](../../../../assets/homey-products-msr2-troubleshooting-msr-2-boot-button.jpg)
...
![](../../../../assets/homey-products-msr2-troubleshooting-msr-2-reflash-pic-1.png)

3\. Select the open com port then click Connect.

![](../../../../assets/homey-products-msr2-troubleshooting-msr-2-reflash-pic-2.png)

4\. Click "Install MSR-2".

![](../../../../assets/homey-products-msr2-troubleshooting-msr-2-reflash-pic-3.png)

5\. Click "INSTALL".

![](../../../../assets/homey-products-msr2-troubleshooting-msr-2-reflash-pic-4.png)

6\. Once you see "Installation complete!" you are finished. Click Next then close out of the browser window.

![](../../../../assets/homey-products-msr2-troubleshooting-air-1-reflash-pic-5.png)
