...
![](../../../assets/homey-products-plt1-calibrating-plt1.md-5-1.png)

4\. Select the ESPHome Integration

![](../../../assets/homey-products-plt1-calibrating-plt1.md-6.png)

5\. Select your PLT-1 device

![](../../../assets/homey-products-plt1-calibrating-plt1.md-7.png)

6\. Scroll down to the diagnostics section and select entity not shown.

![](../../../assets/homey-products-plt1-calibrating-plt1.md-1-5.png)

7\. Select the entity “Soil ADC.”

![](../../../assets/homey-products-plt1-calibrating-plt1.md-1-6.png)

8\. Select the gear icon

![](../../../assets/homey-products-plt1-calibrating-plt1.md-2-1.png)

9\. Select Enable

![](../../../assets/homey-products-plt1-calibrating-plt1.md-3.png)
...
![](../../../assets/homey-products-plt1-calibrating-plt1.md-4.png)
...
![](../../../assets/homey-products-plt1-calibrating-plt1.md-5-2.png)
