...
![](../../../../assets/homey-products-temp1-examples-temp-1-temp-probe-ex-automation-pic-1.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-temp-probe-ex-automation-pic-2.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-temp-probe-ex-automation-pic-3.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-temp-probe-ex-automation-pic-4.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-temp-probe-ex-automation-pic-5.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-temp-probe-ex-automation-pic-6.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-food-probe-ex-automation-pic-1.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-food-probe-ex-automation-pic-3.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-food-probe-ex-automation-pic-5.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-food-probe-ex-automation-pic-6.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-1.png)

2\. Edit your dashboard, add a button card, select Chicken Monitor, and then save.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-3.png)![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-2.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-4.png)

5\. Create a Trigger ID for this called "Chicken Monitor On".

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-5.png)![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-6-1.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-21.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-7.png)

8\. Create a Trigger ID for this called "Temp Reached".

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-8.png)

9\. Click Add Action and search "choose" then select it.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-12.png)

10\. Under option 1 select "Add Condition" then search "trigger id" and select Triggered by.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-13.png)

11\. Check off the option "Button Pressed" that we created in step 5 above.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-14.png)

12\. While still under Option 1 in the choose action: Click Add Action and search "light" then select Light: Turn on.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-9.png)

13\. Click choose entity then search for your device such as "Temp-1 RGB Light".

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-10.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-11.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-15.png)

16\. Write in a custom title and or message- the message is required but the title is not.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-16.png)

17\. This is how option 1 will look when you are done with this part:

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-17-1.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-18-1.png)

20\. While still under Option 2 in the choose action: Click Add Action and search "repeat" then select "Until" in the dropdown.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-22.png)

21\. Under Until Conditions, select "Add condition" then search "state".

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-25.png)

22\. Type in Chicken Monitor and select it, then click "Off" in the dropdown for the state of the sensor.

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-26.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-27.png)

24\. Search "light toggle" in the search bar shown then select "Choose entity" and select your the rgb led for your device

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-28.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-29.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-30.png)![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-31.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-19.png)

29\. Click choose entity then search for your device such as "Temp-1 RGB Light".

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-20.png)
...
![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-33.png)

31\. Click save in the bottom right then give it a name and save

![](../../../../assets/homey-products-temp1-examples-temp-1-cook-chicken-example-pic-34.png)
