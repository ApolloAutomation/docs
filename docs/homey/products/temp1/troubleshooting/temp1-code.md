...
![](../../../../assets/homey-products-temp1-troubleshooting-temp-1-reflash-pic-1.png)

3\. Select the open com port then click Connect.

![](../../../../assets/homey-products-temp1-troubleshooting-temp-1-reflash-pic-2.png)

4\. Click "Install ApolloAutomation.TEMP-1".

![](../../../../assets/homey-products-temp1-troubleshooting-temp-1-reflash-pic-3.png)

5\. Click "INSTALL".

![](../../../../assets/homey-products-temp1-troubleshooting-temp-1-reflash-pic-4.png)

6\. Once you see "Installation complete!" you are finished. Click Next then close out of the browser window.

![](../../../../assets/homey-products-temp1-troubleshooting-temp-1b-reflash-pic-7.png)
