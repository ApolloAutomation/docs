...
![](../../../assets/products-btn1-troubleshooting-btn-1-plug-in-usb-c.webp)

2\. With the device facing you, locate the reset (left) and boot (right) buttons.

![](../../../assets/products-btn1-troubleshooting-btn-1-reset-boot-buttons.png)
...
![](../../../assets/products-btn1-troubleshooting-btn-1-boot-mode-method-2.webp)
...
![](../../../assets/products-btn1-troubleshooting-btn-1-reflash-installer-connect.gif)

5\. Click Install **BTN-1** then click **Install** again.

![](../../../assets/products-btn1-troubleshooting-btn-1-reflash-install.gif)

6\. Once you see "Installation complete!" you are finished. Click Next then close out of the browser window.

![](../../../assets/products-btn1-troubleshooting-pump-1-reflash-install-complete.png)
