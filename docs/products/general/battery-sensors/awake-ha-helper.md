...
![](../../../assets/products-general-battery-sensors-awake-ha-helper-pic-1.png)

![](../../../assets/products-general-battery-sensors-awake-ha-helper-pic-2.png)

2\. Select Create Helper in the bottom right.<br>

![](../../../assets/products-general-battery-sensors-awake-ha-helper-pic-4.png)

<br>3\. Scroll down to the bottom and select Toggle.

![](../../../assets/products-general-battery-sensors-awake-ha-helper-pic-3-1.png)

<br>4\. For name use "apollo\_ota\_mode" and choose desired icon such as "mdi:sleep-off" then click Create.

![](../../../assets/products-general-battery-sensors-awake-ha-helper-pic-5.png)

5\. Search "apollo\_ota\_mode" and click on the helper shown.

![](../../../assets/products-general-battery-sensors-awake-ha-helper-pic-6.png)

<br>6\. Toggle the OTA mode on as shown below.

![](../../../assets/products-general-battery-sensors-toggle-ota-mode-on.png)
...
![](../../../assets/products-general-battery-sensors-toggle-ota-mode-automation-1.png)

![](../../../assets/products-general-battery-sensors-toggle-ota-mode-automation-2.png)
...
![](../../../assets/products-general-battery-sensors-toggle-ota-mode-automation-3.png)
...
![](../../../assets/products-general-battery-sensors-toggle-ota-mode-automation-4.png)

11\. Now select choose entity and select apollo\_ota\_mode as shown below.

![](../../../assets/products-general-battery-sensors-toggle-ota-mode-automation-5.png)
