...
!!! tip "This should be done every 1-2 years."
    ...
    The [SCD40 CO<sub>2</sub> sensor](https://sensirion.com/products/catalog/SCD40 "Docmentation on SCD40 CO<sub>2</sub> Sensor!"){:target="\_blank" rel="noopener noreferrer"} has a long lifetime ([over 10 years](https://sensirion.com/media/documents/48C4B7FB/66E05452/CD_DS_SCD4x_Datasheet_D1.pdf "scd10 datasheet showing lifetime over 10 years")) but it requires re-calibration after 1-2 years back to a 420 ppm baseline!
