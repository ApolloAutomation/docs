...
![](../../../assets/products-general-calibrating-and-updating-mmwave-tuning-pic-1.png)

4\. Scroll down to the Diagnostic section and you will see that REM shows the move and still energy for gates 0-8.

![](../../../assets/products-general-calibrating-and-updating-mmwave-tuning-pic-2-1.png)

5\. The gates are different distances from the sensor.

![Radar Gates Colored](../../../assets/products-general-calibrating-and-updating-radar-gates-colored.png "Radar Gates Colored")
...
![](../../../assets/products-general-calibrating-and-updating-mmwave-tuning-pic-3.png)
...
![](../../../assets/products-general-calibrating-and-updating-mmwave-tuning-pic-4.png)
