...
![image.png](../../../assets/products-general-troubleshooting-esphome-device-builder-addon-image.png)

2\. On the device you would like to remove, click the three dots and select "Delete" then click Delete to confirm.

![](../../../assets/products-general-troubleshooting-delete-device-from-esphome-device-builder-gif.gif)
...
![](../../../assets/products-general-troubleshooting-delete-device-from-esphome-integration-gif.gif)