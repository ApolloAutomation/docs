...
![mdns1.PNG](../../../assets/products-general-troubleshooting-mdns1.PNG)

3\. Select Settings.

![mdns2.PNG](../../../assets/products-general-troubleshooting-mdns2.PNG)

4\. Select Networks.

![mdns3.PNG](../../../assets/products-general-troubleshooting-mdns3.PNG)

5\. Select the Default Network

![mdns4.PNG](../../../assets/products-general-troubleshooting-mdns4.PNG)

6\. Check Multicast DNS

![mdns5.PNG](../../../assets/products-general-troubleshooting-78Kmdns5.PNG)
...
![mmdns1.PNG](../../../assets/products-general-troubleshooting-mmdns1.PNG)

2\. Tap Settings/Gear Icon

![mmdns2.PNG](../../../assets/products-general-troubleshooting-mmdns2.PNG)

3\. Tap Networks

![mmdns3.PNG](../../../assets/products-general-troubleshooting-mmdns3.PNG)

4\. Tap Default Network

![mmdns4.PNG](../../../assets/products-general-troubleshooting-mmdns4.PNG)

5\. Tap the Multicast DNS slider

![mmdns5.PNG](../../../assets/products-general-troubleshooting-mmdns5.PNG)
