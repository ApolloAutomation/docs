...
If you encounter the below error, please complete the [Putting H-1 In Boot Mode Document](https://apolloautomation.github.io/docs/products/plt1/plt1-boot-mode/) and go back to step 3.
