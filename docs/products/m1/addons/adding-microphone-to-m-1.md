...
![](../../../assets/products-m1-addons-m-1-microphone-addon-image.jpg)
...
![](../../../assets/products-m1-addons-m-1-audio-reactive-pin-settings.png)

5\. Scroll to the bottom of the **AudioReactive** settings and set the **Mode** to **Off** and click **Save**.

![](../../../assets/products-m1-addons-m-1-audio-reactive-mode-off.png)