...
![](../../../assets/products-m1-examples-dancing-cat.gif)
...
![](../../../assets/products-m1-examples-m-1-create-gifs-resize-gifs.gif)
...
![](../../../assets/products-m1-examples-m-1-create-gifs-resize-gifs-save.gif)
...
![](../../../assets/products-m1-examples-m-1-create-gifs-rename-gif.gif)
...
![](../../../assets/products-m1-examples-m-1-create-gifs-upload-gif-to-wled.gif)
...
![](../../../assets/products-m1-examples-m-1-create-gifs-select-image-effect.gif)
...
![](../../../assets/products-m1-examples-m-1-create-gifs-enter-gif-name-as-segment-name.gif)

9\. Click on **\+ Preset** and write in any name you want such as Cat Dance then click **Save**.

![](../../../assets/products-m1-examples-m-1-create-gifs-save-gif-as-preset.gif)
...
![](../../../assets/products-m1-examples-m-1-create-gifs-set-preset-as-boot.gif)