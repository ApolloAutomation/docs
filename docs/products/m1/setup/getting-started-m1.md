...
![](../../../assets/products-m1-setup-m1-matrix-attach-controller.webp)
...
![](../../../assets/products-m1-setup-m-1-getting-started.png)
...
![](../../../assets/products-m1-setup-m-1-led-settings.gif)
...
![](../../../assets/products-m1-setup-m-1-2d-settings.gif)
...
![](../../../assets/products-m1-setup-m-1-setup-wled-integration-add-device.png)

2\. Click Add and then Click Submit.

![](../../../assets/products-m1-setup-m-1-setup-wled-integration-click-submit.png)

3\. Give it a name and a location and then click Skip and Finish.

![](../../../assets/products-m1-setup-m-1-setup-wled-integration-name-location-finish.png)
...
![](../../../assets/products-m1-setup-m-1-setup-wled-integration-click-device-2.png)

5\. From here you can control your M-1 LED Matrix by changing the color, selecting presets, and more!

![](../../../assets/products-m1-setup-m-1-setup-wled-integration-test-device.png)
