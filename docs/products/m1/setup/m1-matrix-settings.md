...
![](../../../assets/products-m1-setup-m-1-user-interface-settings.gif)
...
![](../../../assets/products-m1-setup-m-1-audio-reactive-pin-settings.png)

Scroll to the bottom of the **AudioReactive** settings and set the **Mode** to **Off** and click **Save**.

![](../../../assets/products-m1-setup-m-1-audio-reactive-mode-off.png)
