...
![Alarmo 7.png](../../../assets/products-msr1-msr1-alarmo-7.png)  
  
![Alarmo 1.png](../../../assets/products-msr1-msr1-alarmo-1.png)  
...
![Alarmo 2.png](../../../assets/products-msr1-msr1-alarmo-2.png)  
...
![Alarmo 3.png](../../../assets/products-msr1-msr1-alarmo-3.png)  
  
5\. You can change the Title, Message, and Name of the alarm notification.  
  
![Alarmo 4.png](../../../assets/products-msr1-msr1-alarmo-4.png)  
...
![Alarmo 5.png](../../../assets/products-msr1-msr1-alarmo-5.png)  
  
7\. Under Action select Turn On and now your sensors RGB lights will turn on when the alarm is triggered.  
  
![Alarmo 6.png](../../../assets/products-msr1-msr1-alarmo-6.png)  
