...
![](../../../assets/products-msr2-troubleshooting-msr-2-boot-button.jpg)
...
![](../../../assets/products-msr2-troubleshooting-msr-2-reflash-pic-1.png)

3\. Select the open com port then click Connect.

![](../../../assets/products-msr2-troubleshooting-msr-2-reflash-pic-2.png)

4\. Click "Install MSR-2".

![](../../../assets/products-msr2-troubleshooting-msr-2-reflash-pic-3.png)

5\. Click "INSTALL".

![](../../../assets/products-msr2-troubleshooting-msr-2-reflash-pic-4.png)
