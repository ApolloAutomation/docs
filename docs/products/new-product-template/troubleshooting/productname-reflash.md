...
![](../../../assets/products-new-product-template-troubleshooting-pump-1-hold-boot-button-video.webp)
...
![](../../../assets/products-new-product-template-troubleshooting-pump-1-reflash-connect-button.png)

5\. Select the open com port then click Connect.

![](../../../assets/products-new-product-template-troubleshooting-pump-1-reflash-com-port.png)

7\.. Click Install PUMP-1.

![](../../../assets/products-new-product-template-troubleshooting-pump-1-reflash-click-install.png)

7\. Click Install.

![](../../../assets/products-new-product-template-troubleshooting-pump-1-reflash-click-install-confirm.png)

8\. Once you see "Installation complete!" you are finished. Click Next then close out of the browser window.

![](../../../assets/products-new-product-template-troubleshooting-pump-1-reflash-install-complete.png)
