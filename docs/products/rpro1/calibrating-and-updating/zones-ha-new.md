...
![](../../../assets/products-rpro1-calibrating-and-updating-r-pro-1-select-detection.png)

3\. Begin entering in the X and Y coordinates for each zone.

![](../../../assets/products-rpro1-calibrating-and-updating-r-pro-1-enter-zone-coordinates-manually.png)
