...
![](../../assets/products-general-calibrating-and-updating-air-1-co2-calibration-portrait-quick-pic-3.jpg)
...
![Image of popup with CO2 calibration choice circled in red](../../assets/products-general-calibrating-and-updating-co2-calibration-quick-pic-1.png)

3\. Click on the button that says "PRESS" and then you are done.

![Image of popup with CO2 calibration press button circled in red](../../assets/products-general-calibrating-and-updating-co2-calibration-quick-pic-2.png)