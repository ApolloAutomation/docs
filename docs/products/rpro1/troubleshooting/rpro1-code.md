...
![](../../../assets/products-rpro1-troubleshooting-r-pro-1-reflash-connect-button.png)

3\. Select the open com port then click Connect.

![](../../../assets/products-rpro1-troubleshooting-r-pro-1-reflash-connect-comp-port.png)

4\. Click "Install R-PRO-1".

![](../../../assets/products-rpro1-troubleshooting-r-pro-1-reflash-click-install.png)

5\. Click "INSTALL".

![](../../../assets/products-rpro1-troubleshooting-r-pro-1-reflash-click-install-to-install.png)

6\. Once you see "Installation complete!" you are finished. Click Next then close out of the browser window.

![](../../../assets/products-rpro1-troubleshooting-r-pro-1-reflash-installation-complete.png)
