---
title: TEMP-1B Prevent Sleep Guide
description: Guide for setting up and using the prevent sleep toggle with the TEMP-1B.
---
# Prevent Sleep
...
![](../../../assets/products-temp1b-setup-temp-1b-prevent-sleep-pic-1.png)

3\. Scroll down until you see "Prevent Sleep" and "Sleep Duration".

![](../../../assets/products-temp1b-setup-temp-1b-prevent-sleep-pic-2.png)
